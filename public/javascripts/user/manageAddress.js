...
document.addEventListener("DOMContentLoaded", () => {
  ...
  emptyAddAddressBtn?.addEventListener("click", () => addAddressBtn?.click());
      ...
      try {
        ...
        if (response.success) {
          ...
          notifications.showToast(
            response.error || response.message || "Failed to add address",
            "error",
          );
        }
      } catch (error) {
    ...
    addressGrid.addEventListener("click", async (e) => {
      ...
      if (target.classList.contains("set-default")) {
        try {
          ...
          notifications.showToast(
            "An error occurred while updating primary address",
            "error",
          );
          console.error("Error:", error);
        }
    ...
    editForm.addEventListener("submit", async (e) => {
      ...
      try {
        ...
        if (response.success) {
          ...
          notifications.showToast(
            response.error || response.message || "Failed to update address",
            "error",
          );
        }
      } catch (error) {
