...
async function fetchCoupons() {
  try {
    ...
    const response = await fetch(
      `/admin/coupons/get?page=${currentPage}&filter=${currentFilter}`,
    );
...
function renderCoupons() {
  ...
  if (!coupons || coupons.length === 0) {
    html =
      '<tr><td colspan="8" style="text-align: center;">No coupons found</td></tr>';
  } else {
                ...
                <tr>
                    ...
                    <td>
                        <div class="action-buttons">
                            <button type="button" class="action-btn" data-coupon-action="edit" data-coupon-id="${coupon._id}">Edit</button>
                            <button type="button" class="action-btn" data-coupon-action="delete" data-coupon-id="${coupon._id}">Delete</button>
                        </div>
                    </td>
                </tr>
            `;
